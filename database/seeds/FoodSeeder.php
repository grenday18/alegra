...
class FoodSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $food->img = '/img/ensalada-pollo.jpg';
        $food->save();
        ...
        $food->img = '/img/patatas-queso.jpg';
        $food->save();
    ...
    private function createFoodRecipe($ingredients,$food_id,$quantities){
        for($i = 0; $i < sizeof($ingredients); $i++){
            ...
            $foodRecipe->ingredient_id = $ingredients[$i];
            $foodRecipe->quantity = $quantities[$i];
            $foodRecipe->save();
        }
    }
}
